...
public class PaymentService {
	...
	public boolean paymentCreate(int userId, String address, String contact, String ccNumber, String ccExpiration,
			String ccPassword) throws SQLException {
		return paymentDataAccess.paymentAdd(userId, address, contact, ccNumber, ccExpiration, ccPassword);
	}
}