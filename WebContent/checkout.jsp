							...
							<div class="checkout-form">
								...
								<div class="checkout-form-inner">
									<form action="Controller" method="post">
										...
										<div class="single-checkout-box">
											<input type="text" name="contact" size="24"
												required="required" placeholder="Contact">
										</div>
										<div class="single-checkout-box">
											<input type="text" name="ccNumber" size="24"
												required="required" placeholder="Credit Card Number">
										</div>
										<div class="single-checkout-box">
											<input type="text" name="ccExpiration" size="24"
												required="required" placeholder="Credit Card Expiration">
										</div>
										<div class="single-checkout-box">
						...
						<div class="checkout-right-sidebar">
							<div class="our-important-note">
								...
								<ul class="important-note">
									<li><a href="#"><i
											class="zmdi zmdi-caret-right-circle"></i>All sales are final.</a></li>
									<li><a href="#"><i
											class="zmdi zmdi-caret-right-circle"></i>No returns accepted.</a></li>
									<li><a href="#"><i
											class="zmdi zmdi-caret-right-circle"></i>Good products
											guaranteed.</a></li>
