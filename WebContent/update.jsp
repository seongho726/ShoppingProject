                ...
                <div class="row">
                    <div class="col-md-6 col-md-offset-3">
                        <ul class="login__register__menu" role="tablist">
                            <li role="presentation" class="login active"><a href="#login" role="tab" data-toggle="tab">Update Product</a></li>
                        </ul>
                    </div>
                </div>
                        ...
                        <div class="htc__login__register__wrap">
                            ...
                            <div id="login" role="tabpanel" class="single__tabs__panel tab-pane fade in active">
                               <form class="login" action = "Controller" method="post">
                                	<input type="text"  name="productId" value="${sessionScope.product.productId}" readonly>
                                    <input type="text"  name="producttype" value="${sessionScope.product.productType}" readonly>
									<input type="text" name="productname"  value="${sessionScope.product.productName}" readonly>
