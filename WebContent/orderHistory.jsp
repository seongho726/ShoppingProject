						...
						<form action="#">
							<div class="table-content table-responsive">
								<table>
									<thead>
										<tr>
											<th class="product-name">Payment ID</th>
											<th class="product-name">User ID</th>
											<th class="product-quantity">Total Count</th>
											<th class="product-subtotal">Total Price</th>
											<th class="product-name">Address</th>
											<th class="product-name">Contact</th>
										</tr>
									</thead>
										<c:forEach items="${sessionScope.payments}" var = "data"> 
									<tbody>
										<tr>
											<th class="product-name">${data.paymentId}</th>
											<th class="product-name">${data.userId}</th>
											<th class="product-quantity">${data.totalCount}</th>
											<th class="product-subtotal">${data.totalPrice}</th>
											<th class="product-name">${data.address}</th>
											<th class="product-name">${data.contact}</th>
										</tr>
									</tbody>
										</c:forEach>
								</table>
