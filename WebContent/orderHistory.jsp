...
<script>               
	function ajaxCart(){
	  ...
	  .then(function () {
		...
		%>
                                        <tr>
                                            <th class="product-name"><%=payment.getPaymentId()%></th>
                                            <th class="product-name"><%=userId%></th>
                                            <th class="product-quantity"><%=payment.getTotalCount()%></th>
                                            <th class="product-subtotal"><%=payment.getTotalPrice()%></th>
                                            <th class="product-name"><%=payment.getAddress()%></th>
                                            <th class="product-name"><%=payment.getContact()%></th>
                                        </tr>
                          <% }%>
                                    </tbody>
                                </table>
