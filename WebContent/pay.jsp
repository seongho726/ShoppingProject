                        ...
                        <div class="col-xs-12">
                            <div class="bradcaump__inner text-center">
                                ...
                                <nav class="bradcaump-inner">
                                  ...
                                  <span class="breadcrumb-item active">Order Confirmed</span>
                                </nav>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="section__title section__title--2 text-center">
                            <h2 class="title__line">Your order is successfully completed.</h2>
                            <p>We will process your orders as soon as possible. 
                            <br>Meanwhile, you could shop other products.</p>
                        </div>
